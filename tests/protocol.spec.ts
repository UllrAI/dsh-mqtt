...
describe('protocol parsing', () => {
  ...
  it.each([
    ...
    [bytes(submit({ timestamp: '2026-08-17' })), 'INVALID_TIMESTAMP'],
    [bytes(submit({ timestamp: '2026-02-30T12:00:00Z' })), 'INVALID_TIMESTAMP'],
    [bytes(submit({ timestamp: '2025-02-29T12:00:00Z' })), 'INVALID_TIMESTAMP'],
    [bytes(submit({ timestamp: '2026-08-17T24:00:00Z' })), 'INVALID_TIMESTAMP'],
